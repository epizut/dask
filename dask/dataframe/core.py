...
Dask Name: {name}, {layers}"""
    ...
    def repartition(
        ...
        divisions : list, optional
            ...
            TimeDelta or DateOffset will defer to freq while a string will defer to partition_size or freq
        ...
        if isinstance(divisions, int):
            ...
            try:
                partition_size = parse_bytes(divisions)
            except ValueError as bytes_exc:
                try:
                    freq = pd.tseries.frequencies.to_offset(divisions)
